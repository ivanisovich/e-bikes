  ...
  <div class="py-8 md:py-16">
          ...
          <div class="mb-6 md:mb-8">
            ...
            <ul class="space-y-1 md:space-y-2 text-gray-300 text-sm md:text-base">
              ...
              >
                <svg 
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-4 w-4 md:h-5 md:w-5 text-green-400 mr-2 mt-0.5"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path 
    ...
    <Transition name="modal">
      ...
      >
        ...
        <div
          class="relative w-full max-w-6xl h-[95vh] md:h-[90vh] bg-gray-900 rounded-lg overflow-hidden flex flex-col 
        ...
        >
          ...
          <div class="md:hidden bg-gray-800 border-b border-gray-700 overflow-x-auto">
            <div class="flex p-2 space-x-2">
              <button
                ...
                class="px-3 py-2 rounded-md text-xs font-medium whitespace-nowrap transition-all duration-300
                     hover:bg-gray-700 focus:outline-none flex-shrink-0"
                :class="
          ...
          <div class="flex flex-1 overflow-hidden flex-col md:flex-row">
              ...
              <div class="p-2">
                <div class="space-y-1">
                  <button
                    ...
                    :key="index"
                    @click="activeCustomizationCategory = index"
                    class="w-full px-4 py-3 rounded-md text-sm font-medium transition-all duration-300
            ...
            <div class="flex-1 flex flex-col md:flex-row overflow-hidden">
              ...
              <div
                class="h-48 sm:h-64 md:h-auto md:w-1/2 bg-black p-4 flex items-center justify-center
              ...
              <div class="md:w-1/2 bg-gray-800 flex-1 overflow-y-auto">
                <div class="p-3 md:p-4 space-y-4 md:space-y-6">
                  ...
                  <TransitionGroup name="list" tag="div" class="space-y-3 md:space-y-4">
                    <div
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-2 md:gap-3">
                          <TransitionGroup name="option" tag="div" class="contents">
                            <button
                              ...
                              class="px-2 py-2 md:px-3 md:py-3 rounded text-xs md:text-sm transition-all duration-300 border
          ...
          <div class="bg-black p-3 md:p-4 flex flex-col sm:flex-row items-center justify-between border-t border-gray-700 gap-3 md:gap-4">
            ...
            <div class="flex space-x-3 md:space-x-4 w-full sm:w-auto">
              <button
                ...
                class="btn btn-outline text-gray-300 border border-gray-600 px-3 py-2 md:px-4 md:py-2 rounded-md
              ...
              <button
                ...
                class="btn btn-primary bg-green-500 text-white px-3 py-2 md:px-4 md:py-2 rounded-md
